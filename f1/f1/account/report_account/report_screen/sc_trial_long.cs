...
{
    public partial class sc_trial_long : DevExpress.XtraEditors.XtraForm
    {
        public sc_trial_long()
        {
            InitializeComponent();
        ...
        //    xtraReport.Parameters["parameter1"].Value = date1.Text;
          ...
          //  xtraReport.Parameters["parameter2"].Value = date2.Text;
